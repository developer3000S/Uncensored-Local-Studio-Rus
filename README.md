...
* **Чат с агентом**: Клик по агенту в боковой панели мгновенно открывает вкладку с чат-отладкой для общения с выбранным ИИ-помощником.
...
База данных и векторные индексы хранятся локально в файле `app/config/studio.db`.
